...
<tr>
   ...
   <center>
     <h2><font color="black"><b><u>Update Goods Master</u> </b></font></h2>
     <%
     	try
          {
 ...
 <form action="updateGoodsAction.do">
 			<table align="center" bordercolor="#6666FF" bgcolor="white">
			<tr><td><input type=hidden name="goodsId" value="<%=id%>"/></td></tr>
			<tr><td><font color="black"><b>Goods Name :</b></font> </td><td><input type=text name="goodsName" value="<%=form.getGoodsName()%>"/></td></tr> 
			<tr><td><font color="black"><b>Goods Description  :</b></font>	 </td><td><textarea name="goodsDesc"><%=form.getGoodsDesc()%></textarea></td></tr>
