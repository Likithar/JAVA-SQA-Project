...
<tr>
  ...
  <p>&nbsp;</p>
     <p align="center">
     <table  align="center" bgcolor="white"><tr><td width="396">
     <span class="style9"><b><h3><u>Goods Registration  Form</u></h3> </b></span>
	...
	<%=request.getParameter("status") %><%} %>
		...
		<table align="center">
			<tr bgcolor="white"><td> <span class="style9"><b>Goods Name :</b></span> </td>
			<td><input type=text name="goodsName"/></td></tr> 
			<tr><td bgcolor="white"> <span class="style9"><b>Goods Description  :</b></span> </td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea name="goodsDesc">
			</textarea> </td></tr>
			<tr bgcolor="white"><td></td>
			<td><input type=submit name="Register" value="Register"/>
			<input type=reset name="Register" value="Reset"/></td></tr></table>
		</form>
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("goodsName","maxlen=20",	"Max length for FirstName is 20");
  frmvalidator.addValidation("goodsName","alpha"," Goods Name Alphabetic chars only");
