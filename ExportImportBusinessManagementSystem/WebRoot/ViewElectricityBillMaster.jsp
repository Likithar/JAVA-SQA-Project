...
CoreList cl=(CoreList)request.getAttribute("viewElectrictyBills");
Enumeration en=cl.elements();
%>
       </b></font>
       <h2><font color="black">View Electricity Bills</font></h2>
         <table align="center" border=1>
           <tr bgcolor="white">
    <td><div align="center"><font color="black"><b>BillDate</b></font></div></td>       
             
<td><div align="center"><font color="black"><b>BillNo</b></font></div></td>         
...
{
ElectricityBillMasterForm form=(ElectricityBillMasterForm)en.nextElement();
