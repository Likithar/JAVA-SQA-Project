...
<tr>
   ...
   <p align="center">
    ...
    <%} %> <span class="style9"><b>Registeration Form </b></span>
    ...
    <table bgcolor="white"> <tr><td>
      ...
      <table border="1" bgcolor="skyblue" bordercolor="#FF0000">
      <tr><td>
      <b>Your EPost-Office Account gives you access to view the EPost-Office details .   If you already have a EPost-Office Account, you can <a href="index.jsp">sign in</a> here.</b> 
...
<table width="403" border="0" align="center">
  ...
  <tr></tr><tr></tr>
    ...
    <tr colspan="3">
    <td><img alt="See Photo Here" id="previewField" src="images/Hindu-God-Hanuman-Photo-0007.jpg" height="140" width="150"></td>
  </tr>
...
//You should create the validator only after the definition of the HTML form
 ...
 frmvalidator.addValidation("phoneNo","Phone");
   ...
   frmvalidator.addValidation("fax","age");
     ...
     <tr><td align="center"><a href="Registerform.jsp"><font color="black"><b>Register form-----?</b></font></a></td></tr> 
      <tr><td align="center"><a href="Recoverpassword.jsp"><font color="black"><b>Recover Form--?</b></font></a></td></tr>
     </table>
