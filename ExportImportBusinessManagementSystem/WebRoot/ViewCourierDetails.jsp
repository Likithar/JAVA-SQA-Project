...
{
CourierDetailsForm form=(CourierDetailsForm)en.nextElement();
report+="</table>";
             session.setAttribute("Report",report);
 %>
<tr><td><input type=checkbox name="TypeId" value="<%=form.getCourierId() %>"></td>
<td align="center"><%=form.getCourierId()%></td>
<td align="center"><%=form.getItemId() %></td>
<td align="center"><%=form.getAmtCharged() %></td></tr>
