...
<tr>
   <td>
    <font color="skyblue"><h1><br></h1>
     ...
     <p align="center">
    <h2><center><font color="black"><b>Goods Registeration Form</b></font></center> </h2>
    <%
	...
	%>
		...
		<table border="1" align="center" bordercolor="#FFFFFF">
			<tr><td bgcolor="white"><div align="center"><font color="black"><b>Country Name :</b></font> </div></td>
			<td bgcolor="white"><div align="center"> 
			 ...
			 <tr><td bgcolor="white"><div align="center"><font color="black"><b>Goods Name :</b></font> </div></td>
			 <td bgcolor="white"><div align="center">
			   <select name="goodsId">
			     <option value="">---Select Any One----</option>
			...
			<td bgcolor="white"><div align="center">
			  <input type=text name="itemName"/> 
					...
					<tr><td bgcolor="white"><div align="center"><font color="black"><b>Goods Images :</b></font> </div></td>
			<td bgcolor="white"><div align="center">
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=file name="itemLaunchVideo"/>
			  </div></td></tr> 
			
					<tr><td bgcolor="white"><div align="center"><font color="black"><b>Goods Lanuch Video :</b></font> </div></td>
					<td bgcolor="white"><div align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					  <input type=file name="itemImage"/> 
					  </div></td></tr>
	 
			<tr><td bgcolor="white"><div align="center"><font color="black"><b>Goods Desc :</b></font> </div></td>
			<td bgcolor="white"><div align="center">
			  <input type=text name="itemDesc"/> 
			  </div></td></tr>
		
			<tr><td bgcolor="white"><div align="center"><font color="black"><b>Price : </b></font></div></td>
			<td bgcolor="white"><div align="center">
			  <input type=text name="price"/>
			  </div></td></tr> 
		
			<tr><td bgcolor="white"><div align="center"></div></td>
			<td bordercolor="#FFFFFF" bgcolor="white"><div align="center">
			  <input type=submit name="Register" value="Register"/> <input type=reset name="Register" value="Reset"/>
			  </div></td></tr></table>
		</form>
...
//You should create the validator only after the definition of the HTML form
 ...
 frmvalidator.addValidation("goodsId","dontselect=0");
  ...
  frmvalidator.addValidation("itemName","alpha"," Item Name Alphabetic chars only");
  ...
  frmvalidator.addValidation("price","req","Please enter Item Price");
   ...
   frmvalidator.addValidation("itemLaunchVideo","req","Please requierd Item Launch Video"); 
