...
<h2>
<form action="RegisterMobileAction.do" method="post">
<table align="center">
			<tr><td>operatorName : </td><td><input type=text name="operatorName"/></td></tr> 
			<tr><td>operatorDesc : </td><td><input type=text name="operatorDesc"/></td></tr> 
