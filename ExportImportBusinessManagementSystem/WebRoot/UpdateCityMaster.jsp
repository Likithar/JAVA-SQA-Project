...
<tr>
   ...
   <center>
  <h2><font color="black"> Update City Details</font></h2>   
<%
...
%>
			...
			<tr><td><font color="black"><strong>Country Name :</strong></font> </td><td><select name="countryId"> 
		<option value="<%=form.getCountryId() %>"><%=form.getCountryname() %></option>
			...
			CountryMasterForm form1=(CountryMasterForm)en1.nextElement();
			 ...
			 <%} %></select></td></tr>
           <tr><td><font color="black"><strong>City Name : </strong></font></td><td><input type=text name="cityName" value="<%=form.getCityName() %>"/> </td></tr>			
			<tr><td> </td><td><input type="hidden" name="cityId" value=<%=id %>></td></tr> 
			<tr><td><font color="black"><strong>City Map :</strong></font> </td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=file name="cityMap"/></td></tr>
			<%String realpath=request.getRealPath("/images"); 
			System.out.println("realpath"+realpath+"/"+form.getCityMap());%>
			<input type="hidden" name="cityMap1" value="<%=realpath+"/"+form.getCityMap()%>"/>
		
				 
			<tr><td><font color="black"><strong>Description :</strong></font> </td><td><input type=text name="description" value="<%=form.getDescription() %>"/> </td></tr>
			<tr><td><font color="black"><strong>Abbrivation :</strong></font> </td><td><input type=text name="abbr" value="<%=form.getDescription() %>"/> </td></tr>
						
			<tr><td></td><td><input type=submit name="Register" value="update"/> </td></tr></table>
		</form>     
     </center>
