...
<tr>
   ...
   <center>
	...
	<body>
	<font color="white" size="5">Electricty Bill Master Form</font>
		<form action="electricityBillAction.do" method="post" name="register">
		 <%int userid=((Integer)session.getAttribute("user")).intValue(); %>
     
		<table align="center" bgcolor="white">
			<tr><td><font color="black"><b>ServiceNo :</b></font> </td><td><input type=text name="serviceNo"/></td></tr> 
			<tr><td><font color="black"><b>No Of Units :</b></font> </td>
			<td><input type=text name="noOfUnits"/> </td></tr>
			<tr><td><font color="black"><b>Bill No :</b></font> </td>
