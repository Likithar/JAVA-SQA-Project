...
<tr bgcolor="white">
<td colspan=2><div align="center" class="style2"><strong><font color="black"><strong>CityName </strong></font></strong></div></td>      
...
CityMasterForm form=(CityMasterForm)en.nextElement();
 %>
 <tr bgcolor="skyblue"><td><input name="TypeId" type="checkbox" value="<%=form.getCityId() %>"></td> 
 <td><a href="UpdateCityMaster.jsp?Id=<%=form.getCityId() %>" class="style1"><font color="white"><u><%=form.getCityName() %></u></font></a></td>
